import{A as e}from"./UIcon.e294d5d7.js";import{g as n}from"./skills.83629859.js";import{C as t}from"./types.1ebf2f37.js";const r=[{slug:"full-time-employment",company:"Conifer Realty, LLC",description:`
		...
		`,contract:t.FullTime,type:"Information Technology",location:"West Henrietta, NY, USA",period:{from:new Date(2021,2,5),to:new Date(2022,2,5)},skills:n("powershell","python","aws","intune"),name:"Support Analyst",color:"blue",links:[],logo:e.InnovativeSol,shortDescription:"Delivered on-site technical support, maintained infrastructure for reliability, collaborated with clients on future IT needs, and installed and troubleshot network devices and software with documented processes."},{slug:"full-time-employment",company:"Conifer Realty, LLC",description:`
