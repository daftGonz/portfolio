import{A as e}from"./UIcon.5ce4af79.js";import{g as n}from"./skills.a63c6458.js";import{C as t}from"./types.1ebf2f37.js";const s=[{slug:"conifer-realty-llc-systems-engineer-II",company:"Conifer Realty, LLC",description:`
		...
		◦ Led an identity and mobile device management initiative to transition to employee-assigned identities and managed devices, implementing MFA and enforcement of conditional access policies through Entra ID and Intune.`,contract:t.FullTime,type:"Information Technology",location:"Rochester, NY, USA",period:{from:new Date(2022,11,5),to:new Date(2025,8,11)},skills:n("json","csv","xml","powershell","python","git","javascript","html","css","saas","azure","aws","veeam","intune","jamfpro","entraid","active-directory","azure-automation","azure-logic-apps","azure-devops"),name:"Systems Engineer II",color:"red",links:[{label:"Company Website",to:"https://coniferllc.com"}],logo:e.ConiferRealtyLLC,shortDescription:"Experienced in enterprise device management across multiple platforms, administration of Microsoft 365 and Azure environments, cloud migration following best practices, and designing secure network solutions. Skilled in deploying and configuring network infrastructure, building CI/CD integrations with Azure DevOps and various SaaS platforms, and leading identity and mobile device management initiatives with strong security enforcement."},{slug:"aero-safe-global-systems-engineer-I",company:"AeroSafe Global",description:`
		...
		◦ Monitored and maintained network infrastructure, troubleshooting issues and coordinating with stakeholders to resolve system problems and enhance network health.`,contract:t.FullTime,type:"Information Technology",location:"Rochester, NY, USA",period:{from:new Date(2022,2,5),to:new Date(2022,10,15)},skills:n("json","csv","xml","powershell","aws","veeam","entraid"),name:"Systems Engineer I",color:"green",links:[{label:"Company Website",to:"https://aerosafeglobal.com"}],logo:e.AeroSafeGlobal,shortDescription:"Maintained secure, highly available infrastructure, automated administrative tasks, managed backups with DR testing, deployed WDS for streamlined device setup, and monitored network systems to ensure performance and reliability."},{slug:"innovative-solutions-support-analyst",company:"Innovative Solutions",description:`
		...
		`,contract:t.FullTime,type:"Information Technology",location:"West Henrietta, NY, USA",period:{from:new Date(2021,2,5),to:new Date(2022,2,5)},skills:n("powershell","python","aws","intune","googleworkspace","jamfpro","veeam"),name:"Support Analyst",color:"blue",links:[{label:"Company Website",to:"https://innovativesol.com"}],logo:e.InnovativeSol,shortDescription:"Delivered on-site technical support, maintained infrastructure for reliability, collaborated with clients on future IT needs, and installed and troubleshot network devices and software with documented processes."},{slug:"conifer-realty-llc-end-user-support-technician-I",company:"Conifer Realty, LLC",description:`
		...
		`,contract:t.FullTime,type:"Information Technology",location:"Rochester, NY, USA",period:{from:new Date(2018,10,16),to:new Date(2021,2,5)},skills:n("powershell","entraid","active-directory"),name:"End-User Support Technician I",color:"red",links:[{label:"Company Website",to:"https://coniferllc.com"}],logo:e.ConiferRealtyLLC,shortDescription:"Installed, repaired, and upgraded PC hardware, created documentation to streamline onboarding and purchasing, supported RBAC policy development, and provided timely hardware and software troubleshooting."}],r="Experience";export{s as i,r as t};
